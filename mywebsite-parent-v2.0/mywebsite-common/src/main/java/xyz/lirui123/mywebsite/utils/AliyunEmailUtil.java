package xyz.lirui123.mywebsite.utils;
...
public class AliyunEmailUtil {
    ...
    // 设置需要操作的账号的AK和SK
    private static final String ACCESS_KEY = "LTAI4G5L3W6uPBj5ydtU8e8z";
    private static final String SECRET_KEY = "S7RXYESAyhe4lGkdcQQu2J0tZn5y4i";
    //地区
    private static final String REGION = "cn-hangzhou";
    //发信地址
    private static final String ACCOUNT_NAME = "lirui@email.lirui123.xyz";
    //发信人昵称
    private static final String FROM_ALIAS = "LiRui";
    //标签
    private static final String TAG_NAME = "lirui";
