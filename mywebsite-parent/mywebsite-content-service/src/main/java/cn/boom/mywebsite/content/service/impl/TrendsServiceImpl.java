...
public class TrendsServiceImpl implements TrendsService {
     ...
     */
    @Override
    public MyWebSiteResult search(TbTrends tbTrends, int pageNum, int pageSize) {
     ...
     */
    @Override
    public MyWebSiteResult add(TbTrends tbTrends) {
     ...
     */
    @Override
    public MyWebSiteResult update(TbTrends tbTrends) {
